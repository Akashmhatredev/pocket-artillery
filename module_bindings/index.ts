...
import MatchRoomRow from "./match_room_table";
...
const tablesSchema = __schema({
  match_room: __table({
    name: 'match_room',
    indexes: [
      { accessor: 'room_code', name: 'match_room_room_code_idx_btree', algorithm: 'btree', columns: [
        'roomCode',
      ] },
    ],
    constraints: [
      { name: 'match_room_room_code_key', constraint: 'unique', columns: ['roomCode'] },
    ],
  }, MatchRoomRow),
  player: __table({
    name: 'player',
